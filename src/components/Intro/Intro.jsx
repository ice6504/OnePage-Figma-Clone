    ...
    <>
      <div className="max-w-screen-xl mx-auto max-xl:px-5">
        <div className="xl:h-screen max-[390px]:py-5 py-10 sm:max-xl:py-5 xl:py-20">
          <div className="grid place-items-center max-lg:grid-rows-4 lg:grid-rows-2 grid-flow-col gap-3 sm:gap-10 xl:gap-x-10 h-full">
            <div className="size-full row-span-1 lg:col-span-2 max-lg:order-none">
              <div className="h-full flex flex-col justify-center gap-5 px-5">
                ...
                <p className="text-blue-yonder-400 leading-7 tracking-wider max-sm:line-clamp-3 max-sm:text-sm">
                  ...
                  ridiculus <br /> mus. Donec quam felis, ultricies nec,
                  pellentesque eu, pretium quis, sem. Nulla consequat massa quis
                  enim.
                </p>
              </div>
            </div>
            <div className=" size-full row-span-1 lg:col-span-2 max-lg:order-last grid grid-cols-2">
              <IconCard />
              <IconCard />
            </div>
            <figure className="row-span-2 lg:col-span-2">
